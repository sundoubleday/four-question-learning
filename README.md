...
本仓库从刘澜《学会如何学习：120堂认知升级课》与《反向学习：学习力的五项修炼》(机械工业出版社, 2025) 两本书共同蒸馏而来：通读全书后提炼出 271 条候选（框架/原则/案例/反例/术语），经三重验证归并为 **8 个可直接调用的 Skills**，并通过 48/48 盲测。
...
![刘澜思维透镜：作者视角层——方法 skill 叠加一层作者思维透镜](assets/liulan-lens.png)
...
- **原书**：
  - 刘澜《学会如何学习：120堂认知升级课》，机械工业出版社，2025。（案例 + 点评体，8 个 skill 的主要来源）
  - 刘澜《反向学习：学习力的五项修炼》，机械工业出版社，2025。（理论系统体，五项修炼框架 + 四问学习法原始定义的来源，用于深化 skill 的理论骨架）
- 两本书是同一套学习力思想体系的两个层次：《反向学习》是"操作系统"（五项修炼 + 坏习惯→修炼的替代关系），《学会如何学习》是"用户界面"（120 个真实案例落地）。
...
感谢刘澜老师的《学会如何学习》与《反向学习》。这套工具的全部方法论归功于这两本原书，本仓库只做了"让它随手可调"的整理工作。
